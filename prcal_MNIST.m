function [p, r, apM, ahd,ap, ph2,IMPATH] = prcal_MNIST(score,label,labelvalue,IMPATH)
% 
...
% Notes: label = MNIST_trnlabel, labelvalue = MNIST_testlabel(i) i.e 1 image only
...
[ap,IMPATH] = apcal(score,label,labelvalue,IMPATH);