...
for i=1:21
    t_strt=21;
    t_end =25;
    MNIST_trndata=[MNIST_trndata; RefSamplesSIFT(((i-1)*100+1):((i-1)*100+100),:)];
    MNIST_trnlabel=[MNIST_trnlabel RefSamplesLabelsSIFT(:,((i-1)*100+1):((i-1)*100+100))];

    MNIST_tstdata=[MNIST_tstdata; RefSamplesSIFT(((i-1)*100+41):((i-1)*100+60),:)];
    MNIST_tstlabel=[MNIST_tstlabel RefSamplesLabelsSIFT(:,((i-1)*100+41):((i-1)*100+60))];
